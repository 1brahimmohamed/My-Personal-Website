  ...
  return (
      <div className={` ${props.className} bg-AAprimary flex flex-col justify-center items-center py-8 space-y-4 `}>
        ...
        <div className="flex flex-row space-x-8">
          <ClickableIcon
            href={"https://github.com/1brahimmohamed"}
            Icon={GithubIcon}
          />
          <ClickableIcon
            href={"https://www.linkedin.com/in/1brahimmohamed/"}
            Icon={LinkedinIcon}
          />
          <ClickableIcon
            href={"https://www.instagram.com/1brahimmohamed/"}
            Icon={InstagramIcon}
          />
          {/*<ClickableIcon*/}
        ...
        <a href={"https://github.com/1brahimmohamed"} className="" target={"_blank"} rel="noreferrer">
          <div
            className="group flex flex-col font-mono justify-center items-center  text-gray-400
    text-sm  space-y-2  "
          >
            <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
              Designed & Built by Ibrahim Mohamed
            </span>
