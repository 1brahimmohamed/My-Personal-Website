        ...
        <div className="font-mono text-xs md:flex hidden flex-row items-center space-x-8 ">
            <motion.div
                ...
                transition={{
                    ...
                    delay: props.finishedLoading ? 0 : 4.4,
                }}
            ...
            <motion.div
                ...
                className="text-AAsecondary"
            >
                <ReactScrollLink to="WhereIHaveVolunteered" spy={true} smooth={true} offset={-270} duration={200}>
                    &gt; 03. <span
                    className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Volunteering</span>
            ...
            <motion.div
                ...
                className="text-AAsecondary"
            >
                <ReactScrollLink to="MySkillsSection" spy={true} smooth={true} offset={-230} duration={200}>
                    &gt; 04. <span
                    className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Skills</span>
